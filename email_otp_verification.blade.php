...
<body
	style="margin: 0; padding: 0; background-color: #f5f5f5; display: flex; justify-content: center; font-family: 'Inter', sans-serif;">
		...
		<tr>
			<td align="center">
				<table width="600" cellpadding="0" cellspacing="0" border="0" style="background: #fff; margin: 20px 0">
					<tr>
						<td>
							<img align="center" width="100%" src="{{URL_BLOB}}logo-trac/header_master.png"
					...
					<tr style="background: #fbfbfb">
							...
							<table cellpadding="0" cellspacing="0" align="center">
								<tr>
									<td style="padding-right: 10px">
										<img src="{{URL_BLOB}}logo-trac/phone_icons.svg" width="18" alt="phone.png"
                        ...
                        ">1500-009</a>
									...
									<td style="padding-left: 20px; padding-right: 10px">
										<img width="18" src="{{URL_BLOB}}logo-trac/mail_icons.svg" alt="email.png"
											style="display: block; text-align: center" />
									</td>
									<td>
								...
								<tr style="border-bottom: 1px solid black">
									<td style="padding-right: 10px; padding-left: 10px">
										<a href="https://www.instagram.com/trac_astra" target="_blank">
											<img width="20" src="{{URL_BLOB}}logo-trac/ig_icons.svg" alt="ig.png"
												style="display: block; text-align: center" />
										</a>
									</td>
									<td style="padding-right: 10px; padding-left: 10px">
										<a href="https://www.tiktok.com/@trac_astra" target="_blank">
											<img src="{{URL_BLOB}}logo-trac/ttk_icons.svg" width="20" alt="ttk.png"
												style="display: block; text-align: center" />
										</a>
									</td>
									<td style="padding-right: 10px; padding-left: 10px">
										<a href="https://www.facebook.com/TRACAstraRentACar/" target="_blank">
											<img width="20" src="{{URL_BLOB}}logo-trac/fb_icons.svg" alt="fb.png"
												style="display: block; text-align: center" />
										</a>
									</td>
									<td style="padding-right: 10px; padding-left: 10px">
										<a href="https://x.com/trac_astra" target="_blank">
											<img width="20" src="{{URL_BLOB}}logo-trac/x_icons.svg" alt="x.png"
												style="display: block; text-align: center" />
										</a>
									</td>
									<td style="padding-right: 10px; padding-left: 10px">
										<a href="https://www.youtube.com/channel/UC-9jLt-k0R30YzImXxnn6PQ"
											target="_blank">
											<img width="20" src="{{URL_BLOB}}logo-trac/yt_icons.svg" alt="yt.png"
												style="display: block; text-align: center" />
										</a>
									</td>
								</tr>
                  ...
                  ">
					...
					<tr>
						<td align="left" style="padding-left: 24px; padding-bottom: 25px">
							<img src="{{URL_BLOB}}logo-trac/brand_logo_footer.svg" alt="brand_logo2.jpg" width="100"
								style="display: block" />
						</td>
						<td align="right">
								...
								<tr>
									<td>
										<a href="https://apps.apple.com/us/app/tractogo-rental-mobil-bus/id1459840738"
											target="_blank">
											<img src="{{URL_BLOB}}logo-trac/download_apple.svg" alt="download_apple.jpg"
												width="120" style="
                                  display: block;
                                  margin: 0 10px;
                                  padding-bottom: 15px;
                                " />
									...
									<td>
										<a href="https://play.google.com/store/apps/details?id=com.trac.tractogo&pcampaignid=web_share"
											target="_blank">
											<img src="{{URL_BLOB}}logo-trac/download_play.svg" alt="download_play.jpg"
												width="120" style="
                                  display: block;
                                  margin: 0 5px;
                                  padding-bottom: 15px;
